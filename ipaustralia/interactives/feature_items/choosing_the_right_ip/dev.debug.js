/*!
 * Project Name: IP Australia Wizard
 * File Build Date: Mon Aug 29 2011 09:37:02 GMT+0800 (CST)
 */
/* logging.js */
...
(function(ND, $){
	$(function($){
		var wizard = ND.wizard().init( {
			contents:'/images/int/chooseip/contents.html',
			data:'/images/int/chooseip/data.js',
			imgSupport: '/images/int/chooseip/test.png'
		});					
	});
