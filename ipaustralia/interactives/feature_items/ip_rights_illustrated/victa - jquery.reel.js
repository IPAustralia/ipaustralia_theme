...
jQuery.reel || (function($, window, document, undefined){
        ...
        on= {
          ...
          */
            ...
            var
              ...
              revolution= 0.025 * get(_revolution_), // Wheel's revolution is just 20 % of full revolution
              origin= recenter_mouse(undefined, undefined, get(_fraction_), revolution, get(_row_)),
              fraction= set(_fraction_, graph(delta, get(_clicked_on_), revolution, get(_lo_), get(_hi_), get(_cwish_))),
              backwards= delta && set(_backwards_, delta < 0),
              velocity= set(_velocity_, 0)
			  //console.log("wheel: " + distance + " delta: " + delta + " rev: " + revolution + " fraction: " + fraction);
            unidle();
            cleanup.call(e);
            t.trigger('fractionChange');
            return false;
          ...
          */
            ...
            if (opt.rows > 1) var
			  ...
			  //console.log("fractionChange: " + fraction + " frame: " + frame);
  ...
  function cdn(path){ return 'images/' + path }
